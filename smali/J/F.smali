...
.method public static b(Landroid/view/View;LJ/u0;Landroid/graphics/Rect;)LJ/u0;
    .locals 1
...
.method public static j(Landroid/view/View;)LJ/u0;
    .locals 7

    sget-boolean v0, LJ/i0;->d:Z
    ...
    :try_start_0
    sget-object v2, LJ/i0;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v2, LJ/i0;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, LJ/i0;->c:Ljava/lang/reflect/Field;
    ...
    invoke-static {v4, v5, v6, v2}, LB/d;->b(IIII)LB/d;

    move-result-object v2

    invoke-virtual {v3, v2}, LJ/m0;->e(LB/d;)V
    ...
    invoke-static {v2, v4, v5, v0}, LB/d;->b(IIII)LB/d;

    move-result-object v0

    invoke-virtual {v3, v0}, LJ/m0;->g(LB/d;)V

    invoke-virtual {v3}, LJ/m0;->b()LJ/u0;

    move-result-object v0

    iget-object v2, v0, LJ/u0;->a:LJ/s0;

    invoke-virtual {v2, v0}, LJ/s0;->p(LJ/u0;)V
    ...
    invoke-virtual {v2, p0}, LJ/s0;->d(Landroid/view/View;)V
    :try_end_0
...
.method public static u(Landroid/view/View;LJ/q;)V
    ...
    invoke-direct {v0, p0, p1}, LJ/E;-><init>(Landroid/view/View;LJ/q;)V
