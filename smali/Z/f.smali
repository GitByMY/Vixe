...
.method public static o(Ljava/io/ByteArrayOutputStream;[B[LZ/c;)Z
    ...
    invoke-direct {v11, v7, v3, v6}, LZ/l;-><init>(I[BZ)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-direct {v6, v4, v5, v7}, LZ/l;-><init>(I[BZ)V
    :try_end_2
    ...
    invoke-direct {v4, v5, v2, v6}, LZ/l;-><init>(I[BZ)V
    :try_end_b
    ...
    iget-object v6, v5, LZ/l;->b:[B

    iget-boolean v5, v5, LZ/l;->c:Z
...
.method public static t(Landroid/content/Context;Ljava/util/concurrent/Executor;LZ/e;Z)V
    ...
    invoke-interface {v8, v4, v14}, LZ/e;->q(ILjava/io/Serializable;)V
    ...
    invoke-static {v1, v11}, LZ/k;->c(Landroid/content/Context;Z)V
    ...
    invoke-virtual {v10, v4, v14}, LZ/b;->b(ILjava/io/Serializable;)V
    ...
    invoke-interface {v8, v7, v6}, LZ/e;->q(ILjava/io/Serializable;)V
    ...
    invoke-interface {v8, v5, v6}, LZ/e;->q(ILjava/io/Serializable;)V
    ...
    :try_start_8
    invoke-static {v6, v4}, LZ/f;->f(Ljava/io/InputStream;I)[B
    ...
    invoke-interface {v8, v15, v6}, LZ/e;->q(ILjava/io/Serializable;)V
    ...
    :goto_9
    :try_start_b
    invoke-interface {v8, v11, v0}, LZ/e;->q(ILjava/io/Serializable;)V
    :try_end_b
    ...
    :goto_a
    invoke-interface {v8, v15, v5}, LZ/e;->q(ILjava/io/Serializable;)V
    ...
    :goto_b
    :try_start_d
    invoke-interface {v8, v15, v0}, LZ/e;->q(ILjava/io/Serializable;)V
    :try_end_d
    ...
    invoke-interface {v8, v3, v2}, LZ/e;->q(ILjava/io/Serializable;)V
    ...
    invoke-static {v5, v4}, LZ/f;->f(Ljava/io/InputStream;I)[B
    ...
    invoke-static {v5, v4, v2, v0}, LZ/f;->i(Ljava/io/FileInputStream;[B[B[LZ/c;)[LZ/c;
    ...
    :goto_14
    invoke-interface {v8, v2, v0}, LZ/e;->q(ILjava/io/Serializable;)V
    ...
    invoke-static {v6, v5, v0}, LZ/f;->o(Ljava/io/ByteArrayOutputStream;[B[LZ/c;)Z
    ...
    invoke-interface {v2, v0, v14}, LZ/e;->q(ILjava/io/Serializable;)V

    iput-object v14, v7, LZ/b;->g:[LZ/c;
    :try_end_17
    ...
    :goto_1b
    invoke-interface {v2, v11, v0}, LZ/e;->q(ILjava/io/Serializable;)V

    goto :goto_1d

    :goto_1c
    invoke-interface {v2, v3, v0}, LZ/e;->q(ILjava/io/Serializable;)V
    ...
    iget-object v0, v7, LZ/b;->d:Ljava/io/File;
    ...
    :try_start_22
    invoke-virtual {v7, v8, v14}, LZ/b;->b(ILjava/io/Serializable;)V
    :try_end_22
    ...
    :goto_2f
    :try_start_30
    invoke-virtual {v7, v2, v0}, LZ/b;->b(ILjava/io/Serializable;)V
    :try_end_30
    ...
    invoke-static {v1, v2}, LZ/k;->c(Landroid/content/Context;Z)V
