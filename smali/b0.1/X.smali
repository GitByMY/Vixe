...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lb0/X;->g:Landroidx/recyclerview/widget/RecyclerView;

    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->u0:LR/d;

    iput-object v0, p0, Lb0/X;->d:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lb0/X;->e:Z
    ...
    iput-object v1, p0, Lb0/X;->c:Landroid/widget/OverScroller;
...
.method public final a()V
    ...
    :cond_0
    iget-object v0, p0, Lb0/X;->g:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final b(IIILandroid/view/animation/BaseInterpolator;)V
    ...
    iget-object v1, p0, Lb0/X;->g:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_5
    iget-object p3, p0, Lb0/X;->d:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_6

    iput-object p4, p0, Lb0/X;->d:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, Lb0/X;->c:Landroid/widget/OverScroller;
    ...
    iget-object v3, p0, Lb0/X;->c:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    iget-object v9, v0, Lb0/X;->g:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->l:Lb0/J;

    if-nez v1, :cond_0

    invoke-virtual {v9, v0}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v1, v0, Lb0/X;->c:Landroid/widget/OverScroller;
    ...
    iput-boolean v10, v0, Lb0/X;->f:Z

    const/4 v11, 0x1

    iput-boolean v11, v0, Lb0/X;->e:Z

    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView;->m()V

    iget-object v12, v0, Lb0/X;->c:Landroid/widget/OverScroller;
    ...
    iget v3, v0, Lb0/X;->b:I

    sub-int v8, v2, v3

    iput v1, v0, Lb0/X;->a:I

    iput v2, v0, Lb0/X;->b:I
    ...
    :cond_2
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->k:Lb0/B;
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->l:Lb0/J;

    iget-object v3, v3, Lb0/J;->e:Lb0/w;

    if-eqz v3, :cond_5

    iget-boolean v4, v3, Lb0/w;->d:Z

    if-nez v4, :cond_5

    iget-boolean v4, v3, Lb0/w;->e:Z

    if-eqz v4, :cond_5

    iget-object v4, v9, Landroidx/recyclerview/widget/RecyclerView;->c0:Lb0/V;

    invoke-virtual {v4}, Lb0/V;->b()I

    move-result v4

    if-nez v4, :cond_3

    invoke-virtual {v3}, Lb0/w;->i()V

    goto :goto_0

    :cond_3
    iget v5, v3, Lb0/w;->a:I

    if-lt v5, v4, :cond_4

    sub-int/2addr v4, v11

    iput v4, v3, Lb0/w;->a:I

    invoke-virtual {v3, v1, v2}, Lb0/w;->g(II)V
    ...
    :goto_5
    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView;->l:Lb0/J;

    iget-object v2, v2, Lb0/J;->e:Lb0/w;

    if-eqz v2, :cond_10

    iget-boolean v2, v2, Lb0/w;->d:Z
    ...
    :cond_1a
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->b0:Lb0/n;
    ...
    :cond_1b
    iput v10, v1, Lb0/n;->d:I

    goto :goto_b

    :cond_1c
    :goto_a
    invoke-virtual/range {p0 .. p0}, Lb0/X;->a()V

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->a0:Lb0/p;

    if-eqz v1, :cond_1d

    invoke-virtual {v1, v9, v15, v14}, Lb0/p;->a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-boolean v2, v1, Lb0/w;->d:Z

    if-eqz v2, :cond_1e

    invoke-virtual {v1, v10, v10}, Lb0/w;->g(II)V

    :cond_1e
    iput-boolean v10, v0, Lb0/X;->e:Z

    iget-boolean v1, v0, Lb0/X;->f:Z
